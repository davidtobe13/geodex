...
//   return (
//     <div className="flex flex-col md:flex-row md:h-[100vh] h-full items-center justify-center overflow-y-hidden">
//       {/* Left side - Form */}
//       <div className="w-full md:w-[50%] p-8 md:p-16 flex flex-col h-full items-center pt-4 justify-center overflow-y-hidden">
