      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precision <span className="text-orange-500">Geo-Targeting</span><br />
            For Modern Advertisers
          </h2>
          <p className="mb-8 text-lg">
            Reach the right audience at the right place with Geodex's advanced location-based advertising solutions.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/" className="border border-white flex items-center justify-center gap-2 text-white px-6 py-3 rounded-md hover:bg-white hover:text-gray-800 transition">
              Watch Video  <ChevronRight width={15}/>
            </Link>
            <Link to="/signup" className="bg-orange-500 text-white px-6 py-3 rounded-md hover:bg-orange-600 transition">
              Join Our Waitlist
            </Link>
          </div>
        </div>
