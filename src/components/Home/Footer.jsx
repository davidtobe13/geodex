        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-orange-500 text-sm">Home</a></li>
              <li><a href="#" className="text-gray-600 hover:text-orange-500 text-sm">About</a></li>
              <li><a href="#" className="text-gray-600 hover:text-orange-500 text-sm">Contact Us</a></li>
              <li><a href="#" className="text-gray-600 hover:text-orange-500 text-sm">Learn</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="flex items-center text-gray-600 hover:text-orange-500 text-sm gap-3">
                  <FaInstagram/>
                  <span>Instagram</span>
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center gap-3 text-gray-600 hover:text-orange-500 text-sm">
